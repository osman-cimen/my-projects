...
aws ec2 create-security-group \
    --group-name roman_numbers_sec_grp_osman\
...
```
```bash
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name aladag-key --security-group-ids sg-00193482779f7630c --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=roman_numbers}]' --user-data file:///home/ec2-user/userdata.sh
or
...
- To delete instances
```bash 
aws ec2 terminate-instances --instance-ids i-04c41876d0d28f624
```
